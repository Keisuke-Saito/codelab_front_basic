...
// 理由：上段は「20」+「2」の計算を実行しているが、
//下段は「20」を文字列として、それに数値の「2」を結合させることを意味しているので、「20」の後ろに「2」が付く「202」という結果となった。
...
// 理由：num2は、変数を代入してからの1加算となるため、1が加えられる前の結果になっている。
//num4は、1加算を行ってから変数を代入しているため、1が加えられた後の結果になっている。
...
// 理由：上段は等価演算子で、値が等しいかどうかで確認しているのに対し、
//下段は厳密等価演算子で、値だけでなく型も正しいかどうかを確認しているため、文字列の10と数値の10を比較しfalseの結果となっている。
